...
public class BasicDream extends Activity {
     ...
     * <li>Hide the system UI (courtesy its inner {@link com.pekall.emdm.launcher.BasicDream.BasicDreamView} class)
     * </ul>
     * Finally, it exposes an {@link com.pekall.emdm.launcher.BasicDream#onDraw(android.graphics.Canvas)} method that you can override to do
     * your own drawing. As with a <code>View,</code> call {@link com.pekall.emdm.launcher.BasicDream#invalidate()} any time
    ...
    public class BasicDreamView extends View {
        /** A simple view that just calls back to {@link com.pekall.emdm.launcher.BasicDream#onDraw(android.graphics.Canvas) onDraw} on its
